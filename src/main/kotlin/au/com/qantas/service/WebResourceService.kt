...
class WebResourceService(
    ...
    fun getWebResource(url: String, depth: Int, pageable: Pageable): WebResource =
        url.fetch(pageable).recurse(depth, pageable)


    private fun String.fetch(pageable: Pageable) = CompletableFuture.supplyAsync(Supplier {
